...
Plus Jakarta Sans mb-2">Enter Your Email</label>
            <input type="text" id="username" name="username" placeholder="user@mail.com" className="w-full px-3 py-2 border rounded-lg focus:outline-none border-slate-400" />
          </div>
          <div className="mb-4">
            <p className="font-light "  >We will send a password reset link to your registered  email ID</p>
          </div>
